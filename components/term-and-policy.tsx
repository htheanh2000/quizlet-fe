  ...
  return (
    <div>
      ...
      <p>
        ...
        your email address, which is required for you to be able to login to the
      ...
      <p>
        ...
        payment processor, Paddle (<a href="https://paddle.com">paddle.com</a>).
        Paddle may ask you for personal and/or non-personal information, such as
        your name, address, email address, credit card information, or other
        Personal Information. Paddle has a privacy policy (
        <a href="https://paddle.com/legal-buyers/">paddle.com/legal-buyers/</a>)
        ...
        information. Any questions or concerns about Paddle’s practices should
        be directed to Paddle.
      </p>
      <p>
        Paddle provides us with certain non-personal information relating to
        purchases made by visitors to the Website. The non-personal information
        may include details of the purchase such as the date, amount paid, and
        product purchased. The non-personal purchase information may be linked
        to the Personal Information you provide to us (typically limited to your
        email address, as stated above). Paddle does not supply us with any of
        your other Personal Information such as your name, street address, or
      ...
      <p>
        ...
        records after deletion of such information from your account for a
        retention period. Once the retention period expires, Personal
        Information shall be deleted. Therefore, the right to access, the right
        to erasure, your rights to access, add to, and update your information
      ...
      <p>
        ...
        updates, etc; and operate our Website. Non-Personal Information
      ...
      <p>
        Where Personal Information is processed for a public interest, in the
      ...
      <p>
        ...
        These requests can be exercised free of charge and will be addressed by
      ...
      <p>
        ...
        Personal Information through our Website. We encourage parents and legal
        ...
        Information through our Website without their permission. If you have
      ...
      <h2>Newsletters</h2>
      <p>
        We offer electronic newsletters which you may voluntarily subscribe to.
      ...
      <p>
        ...
        purposes to operate our Website. You have the ability to accept or
      ...
      <p>
        In particular, as noted above, purchases made through the Website are
        handled by Paddle and all such transactions, including any Personal
        Information or non-personal information collected by Paddle, are under
        the control of Paddle. We encourage purchasers to read Paddle’s Privacy
        Policy (
        <a href="https://paddle.com/legal-buyers/">paddle.com/legal-buyers/</a>
        ).
      </p>
      ...
      <p>
        ...
        terms and conditions. By using the Website you agree to be bound by this
        Policy. If you do not agree to abide by the terms of this Policy, you
        are not authorized to use or access the Website.
      </p>
      <h2>Contacting us</h2>
      <p>
        If you have any questions about this Policy, please contact us by email
        at <a href="mailto:support@tailwindui.com">support@tailwindui.com</a>.
      </p>
    </div>
  )
}
